...
const filteredTodos = computed(() => {
  ...
  return todos.value.filter(todo => todo.done.toString() === filter.value)
})

const todos_asc = computed(() => filteredTodos.value.sort((a, b) => a.createdAt - b.createdAt))
  ...
  <main class="app">
    ...
    <section class="todo-list">
      ...
      <div class="filter">
        ...
        <label>
          <input type="radio" name="filter" value="true" v-model="filter" />
          Completed
        </label>
        <label>
          <input type="radio" name="filter" value="false" v-model="filter" />
          Incomplete
        </label>
      </div>
